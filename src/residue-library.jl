...
function getPDB(residue::String; pdbname=nothing)
    ...
    if residue == "ENP" || residue == "phosphoethanolamine" || residue == "EthNP" || residue == "pEtN"
        ...
        Base.write(pdb, "HETATM    5  CA  ENP     1       0.731  -1.493  -0.061  1.00  0.00      U    C\n")
        Base.write(pdb, "HETATM    6  HA1 ENP     1       0.458  -1.998  -0.988  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM    7  HA2 ENP     1       0.410  -2.084   0.797  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM    8  CB  ENP     1       0.169  -0.086  -0.022  1.00  0.00      U    C\n")
        Base.write(pdb, "HETATM    9  HB1 ENP     1       0.576   0.524  -0.843  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM   10  HB2 ENP     1       0.441   0.404   0.928  1.00  0.00      U    H\n")
