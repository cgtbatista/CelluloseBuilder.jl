...
function get_position_info(reference::String, decoration::String, residue::String; resid=nothing, segid=nothing)
    ...
    if residue == "ENP" || residue == "phosphoethanolamine" || residue == "EthNP" || residue == "pEtN"
        ...
        idx4 = PDBTools.index.(
                PDBTools.select(pdb2, (atom -> atom.name == "O1"))
            )[1]
    end
...
function getPDB(residue::String; pdbname=nothing)
    ...
    if residue == "ENP" || residue == "phosphoethanolamine" || residue == "EthNP" || residue == "pEtN"
        ...
        Base.write(pdb, "HETATM    5  C2  ENP     1       0.731  -1.493  -0.061  1.00  0.00      U    C\n")
        ...
        Base.write(pdb, "HETATM    8  C1  ENP     1       0.169  -0.086  -0.022  1.00  0.00      U    C\n")
        ...
        Base.write(pdb, "HETATM   12  O3  ENP     1      -3.455   0.906  -0.453  1.00  0.00      U    O\n")
        Base.write(pdb, "HETATM   13  O4  ENP     1      -1.143   2.237  -0.755  1.00  0.00      U    O\n")
        Base.write(pdb, "HETATM   14  O1  ENP     1      -1.865   1.459   1.564  0.00  0.00      U    O\n")
        Base.write(pdb, "HETATM   15  O2  ENP     1      -1.207  -0.267  -0.142  1.00  0.00      U    O\n")
        Base.write(pdb, "HETATM   16  HO  ENP     1      -1.632   2.399   1.669  0.00  0.00      U    H\n")
    else
