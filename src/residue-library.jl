...
function get_position_info(reference::String, decoration::String, residue::String; resid=nothing, segid=nothing)
    ...
    if residue == "ENP" || residue == "phosphoethanolamine" || residue == "EthNP" || residue == "pEtN"
        ...
        idx4 = PDBTools.index.(
                PDBTools.select(pdb2, (atom -> atom.name == "OP1"))
            )[1]
    end
...
function getPDB(residue::String; pdbname=nothing)
    ...
    if residue == "ENP" || residue == "phosphoethanolamine" || residue == "EthNP" || residue == "pEtN"
        Base.write(pdb, "HETATM    1  NP  ENP     1       2.249  -1.408  -0.019  1.00  0.00      U    N\n")
        Base.write(pdb, "HETATM    2  HP1 ENP     1       2.708  -2.325  -0.058  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM    3  HP2 ENP     1       2.550  -0.931   0.841  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM    4  HP3 ENP     1       2.584  -0.845  -0.811  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM    5  CP2 ENP     1       0.731  -1.493  -0.061  1.00  0.00      U    C\n")
        Base.write(pdb, "HETATM    6  HPC ENP     1       0.458  -1.998  -0.988  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM    7  HPD ENP     1       0.410  -2.084   0.797  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM    8  CP1 ENP     1       0.169  -0.086  -0.022  1.00  0.00      U    C\n")
        Base.write(pdb, "HETATM    9  HPA ENP     1       0.576   0.524  -0.843  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM   10  HPB ENP     1       0.441   0.404   0.928  1.00  0.00      U    H\n")
        Base.write(pdb, "HETATM   11  P   ENP     1      -2.051   1.236  -0.086  1.00  0.00      U    P\n")
        Base.write(pdb, "HETATM   12  OP4 ENP     1      -1.143   2.237  -0.755  1.00  0.00      U    O\n")
        Base.write(pdb, "HETATM   13  OP3 ENP     1      -3.455   0.906  -0.453  1.00  0.00      U    O\n")
        Base.write(pdb, "HETATM   14  OP2 ENP     1      -1.207  -0.267  -0.142  1.00  0.00      U    O\n")
        Base.write(pdb, "HETATM   15  OP1 ENP     1      -1.865   1.459   1.564  0.00  0.00      U    O\n")
