function _cellulose_topfile(; filename=nothing)
    ...
    Base.write(topology_file, "read rtf card append\n")
    Base.write(topology_file, "36 1\n\n")
    Base.write(topology_file, "AUTOGENERATE ANGLES DIHEDRALS\n")
    ...
    Base.write(topology_file, "MASS  -1  CG324     12.01100 C ! aliphatic C for CH2, adjacent to positive N (piperidine) (+)\n")
    Base.write(topology_file, "MASS  -1  CG321     12.01100 C ! aliphatic C for CH2\n")
    ...
    Base.write(topology_file, "MASS  -1  HGA2       1.00800 H ! alphatic proton, CH2\n")
    Base.write(topology_file, "MASS  -1  HGP1       1.00800 H ! polar H\n")
    Base.write(topology_file, "MASS  -1  HGP2       1.00800 H ! polar H, +ve charge\n")
    ...
    Base.write(topology_file, "MASS  -1  OG2P1     15.99940 O ! =O in phosphate or sulfate\n")
    Base.write(topology_file, "MASS  -1  OG311     15.99940 O ! hydroxyl oxygen\n")
    Base.write(topology_file, "MASS  -1  OG303     15.99940 O ! phosphate/sulfate ester oxygen\n")
    Base.write(topology_file, "!! nitrogen\n")
    Base.write(topology_file, "MASS  -1  NG3P3     14.00700 N ! primary NH3+, phosphatidylethanolamine\n")
    Base.write(topology_file, "!! phosphorous\n")
    Base.write(topology_file, "MASS  -1  PG1       30.97380 P  ! phosphate -1\n")
    Base.write(topology_file, "! DEFAults for patching FIRSt and LAST residues\n")
    Base.write(topology_file, "DEFA FIRS NONE LAST NONE\n")
    Base.write(topology_file, "AUTOGENERATE ANGLES DIHEDRALS PATCH DRUDE\n")
    Base.write(topology_file, "\n")
    ...
    Base.write(topology_file, "\n")
    Base.write(topology_file, "RESI PETN           0.000 ! param penalty=   0.000 ; charge penalty=   0.000\n")
    Base.write(topology_file, "GROUP            ! CHARGE   CH_PENALTY Z   EL   NB NBE RNG1 TYP RNG2 TYP RNG3 TYP\n")
    Base.write(topology_file, "ATOM N      NG3P3  -0.293 !    0.000   7   N    4  4\n")
    Base.write(topology_file, "ATOM HN1    HGP2    0.328 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "ATOM HN2    HGP2    0.328 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "ATOM HN3    HGP2    0.328 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "ATOM C2     CG324   0.130 !    0.000   6   C    4  4\n")
    Base.write(topology_file, "ATOM H2A    HGA2    0.090 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "ATOM H2B    HGA2    0.090 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "ATOM C1     CG321  -0.084 !    0.000   6   C    4  4\n")
    Base.write(topology_file, "ATOM H1A    HGA2    0.090 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "ATOM H1B    HGA2    0.090 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "ATOM P      PG1     1.505 !    0.000   15  P    4  5\n")
    Base.write(topology_file, "ATOM O3     OG2P1  -0.824 !    0.000   8   O    1  2\n")
    Base.write(topology_file, "ATOM O4     OG2P1  -0.824 !    0.000   8   O    1  1\n")
    Base.write(topology_file, "ATOM O1     OG311  -0.669 !    0.000   8   O    2  2\n")
    Base.write(topology_file, "ATOM O2     OG303  -0.623 !    0.000   8   O    2  2\n")
    Base.write(topology_file, "ATOM HO     HGP1    0.338 !    0.000   1   H    1  1\n")
    Base.write(topology_file, "               ! TYP INR\n")
    Base.write(topology_file, "BOND N    HN1  ! 1   0\n")
    Base.write(topology_file, "BOND N    HN2  ! 1   0\n")
    Base.write(topology_file, "BOND N    HN3  ! 1   0\n")
    Base.write(topology_file, "BOND N    C2   ! 1   0\n")
    Base.write(topology_file, "BOND C2   C1   ! 1   0\n")
    Base.write(topology_file, "BOND C2   H2A  ! 1   0\n")
    Base.write(topology_file, "BOND C2   H2B  ! 1   0\n")
    Base.write(topology_file, "BOND C1   H1A  ! 1   0\n")
    Base.write(topology_file, "BOND C1   H1B  ! 1   0\n")
    Base.write(topology_file, "BOND C1   O2   ! 1   0\n")
    Base.write(topology_file, "BOND P    O3   ! 2   0\n")
    Base.write(topology_file, "BOND P    O1   ! 1   0\n")
    Base.write(topology_file, "BOND P    O4   ! 1   0\n")
    Base.write(topology_file, "BOND P    O2   ! 1   0\n")
    Base.write(topology_file, "BOND O1   HO   ! 1   0\n")
    Base.write(topology_file, "PATC FIRS NONE LAST NONE\n")
    Base.write(topology_file, "\n")
